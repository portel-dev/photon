...
* **a2ui:** action round-trip — button name dispatches photon method ([f3f0d33](https://github.com/portel-dev/photon/commit/f3f0d33bf388da4d5f95940481f158f9c5bbf71f))
* **a2ui:** Beam renderer + end-to-end tests + docs ([fc64192](https://github.com/portel-dev/photon/commit/fc641925ed423f7975fbe4e1c8b4bf3fa8a20fc4))
* **audit:** SQLite-backed audit store with runtime-agnostic loader ([ee8b653](https://github.com/portel-dev/photon/commit/ee8b6538efdd0b02465678a33bd217949cbc510a))
* **beam:** daemon panel UI — four tables, actions, history drawer ([7a0bbc7](https://github.com/portel-dev/photon/commit/7a0bbc73e31f1596fb5b6a1761e90afe1d3207b8)), closes [#16](https://github.com/portel-dev/photon/issues/16)
* **beam:** HTTP wrappers around the daemon ps/schedule RPCs ([97d28e4](https://github.com/portel-dev/photon/commit/97d28e44c62078d1501041938d4afae5794678ce))
* **beam:** instance label + JSDoc help text in Settings tabs ([9cc3719](https://github.com/portel-dev/photon/commit/9cc3719c3fe04b26c6bf05f2b474a7c58e79f026))
* **beam:** split Settings view into Setup + Configuration sub-tabs ([7e6a489](https://github.com/portel-dev/photon/commit/7e6a48944e4bb64adfc260c3d6acde6608e93a3d))
* **cli:** add 'photon new' as a top-level shortcut for 'photon maker new' ([e66cfb7](https://github.com/portel-dev/photon/commit/e66cfb7425936291a17c71e4d6ec51feb94b518d))
* **cli:** announceContext adoption across PHOTON_DIR-sensitive commands ([78cf93a](https://github.com/portel-dev/photon/commit/78cf93a480584f1a99e09c15ac376f0d720d52a7))
* **cli:** announceContext helper + --verbose/--json context envelope ([a178d42](https://github.com/portel-dev/photon/commit/a178d4279ffade88cef4e14831033836650118d3))
* **daemon:** brand registry-key types so bare-string lookups don't compile ([7f5ac35](https://github.com/portel-dev/photon/commit/7f5ac3585b7004980b3924bd59feb2bd4e53e411))
* **daemon:** brand scheduledJobs/jobTimers keys + route disable through unscheduleJob ([99476fa](https://github.com/portel-dev/photon/commit/99476fa868ddbd4fb856fbbc05a8abd3db0c2145))
* **daemon:** brand the remaining photon-scoped maps + patch two latent multi-base bugs ([78e991e](https://github.com/portel-dev/photon/commit/78e991e147c8cb79b25d9e5c48e02b2193040b4a))
* **daemon:** discover [@scheduled](https://github.com/scheduled) and [@webhook](https://github.com/webhook) tags at boot, lazy-load on fire ([c6206d3](https://github.com/portel-dev/photon/commit/c6206d3db85772f587536974fe664a56c377367b))
* **daemon:** live watcher for [@scheduled](https://github.com/scheduled) / [@webhook](https://github.com/webhook) tag edits ([2725f3c](https://github.com/portel-dev/photon/commit/2725f3cc06f509526262efe9907da0020b03c896))
* **daemon:** SQLite backend for execution history with indexed queries ([c10ae80](https://github.com/portel-dev/photon/commit/c10ae80c5744d1cf5ca33ff9da6f506e5b29b38f))
* **doctor:** tool-sprawl and secret-named-param lints ([abc331d](https://github.com/portel-dev/photon/commit/abc331dbd0d5f1dd871226ed4d368b32aac8352e)), closes [#4](https://github.com/portel-dev/photon/issues/4) [#5](https://github.com/portel-dev/photon/issues/5) [#3](https://github.com/portel-dev/photon/issues/3)
* **errors:** link common errors to TROUBLESHOOTING.md ([be914fa](https://github.com/portel-dev/photon/commit/be914fadaa828fbeffb4eab2593699e9d3260db9)), closes [#photon-not-found](https://github.com/portel-dev/photon/issues/photon-not-found) [#mcp-not-found-in-marketplace](https://github.com/portel-dev/photon/issues/mcp-not-found-in-marketplace) [#photon-not-found](https://github.com/portel-dev/photon/issues/photon-not-found) [#missing-environment-variables](https://github.com/portel-dev/photon/issues/missing-environment-variables)
* **loader:** inject this.shell with cwd pinned to the photon's folder ([4d4b791](https://github.com/portel-dev/photon/commit/4d4b791ef0a6f05735fd9d036deb9a60a5418e35))
* **loader:** register stat-gate reloader for CLI-direct dispatch ([0db9177](https://github.com/portel-dev/photon/commit/0db9177f14d06b70649820e02fbb300f6fe264c2)), closes [#17](https://github.com/portel-dev/photon/issues/17)
* **maker:** scaffold new photons into CWD by default, --global opts into ~/.photon ([6b32479](https://github.com/portel-dev/photon/commit/6b324798625204293a08d0690d853faa0e7768d9))
* **mcp:** add 'photon mcp install' to register a photon in Claude Desktop ([366133e](https://github.com/portel-dev/photon/commit/366133e1a3d0968ec8a85906aca4eebbd1a29388))
* **new:** add --for and --force flags to scaffold command ([848bcd8](https://github.com/portel-dev/photon/commit/848bcd81ae27cbee9eb4ca610c31554f7a1cac75))
* **ps:** `photon ps` command for observing + controlling scheduled work ([157e33f](https://github.com/portel-dev/photon/commit/157e33f534e8fb77f61a3c4d17069c18d1aa85a3))
* **schedules:** cross-base startup scan + legacy IPC sweep ([3c44a88](https://github.com/portel-dev/photon/commit/3c44a8832de7500b8cd1c2f114e43bf563f26031))
* **schedules:** persist execution history for scheduled jobs ([1dbdf82](https://github.com/portel-dev/photon/commit/1dbdf8228d950dc62bbad492d4349946a1c064c5))
* **schedules:** two-step model — declare via [@scheduled](https://github.com/scheduled), enroll via active list ([45da5c1](https://github.com/portel-dev/photon/commit/45da5c1db7777127bd0d7da9240b6f36c24945bf))
* **security:** default 60/min rate limits on webhook + /mcp transports ([b7766b6](https://github.com/portel-dev/photon/commit/b7766b6be03a8ad41eaddc96c7fd852ab56cc2aa))
* **serv:** HTTP adapter mounts the OAuth 2.1 endpoints onto Node's http server ([1d79b00](https://github.com/portel-dev/photon/commit/1d79b00aa02a03a5f8c95b3762b5719d08404d7c))
* **serv:** OAuth 2.1 authorization server endpoints with CIMD + DCR ([f97b473](https://github.com/portel-dev/photon/commit/f97b4739124ec8697f8a297f397216ab1b222f11))
* **serv:** Serv-class factory + OTel metrics + AS docs ([8f3cefc](https://github.com/portel-dev/photon/commit/8f3cefcc0ee629402836516691350106d132957d))
* **serv:** SQLite elicitation + grant stores for upstream OAuth persistence ([4a4c001](https://github.com/portel-dev/photon/commit/4a4c001f7204ce6aea809f94d6cd86d100400322))
* **serv:** token revocation/introspection, OIDC id_token, RS256/ES256, RFC 8693 token exchange, SQLite persistent stores ([7e17ac0](https://github.com/portel-dev/photon/commit/7e17ac0ea0c8011085b28d4538c87a45fc3ea842))
* **update,upgrade:** add --dry-run to preview changes before installing ([2d3970a](https://github.com/portel-dev/photon/commit/2d3970aecaa4613c9d97d0dba0a702bc514fe644))
* **version:** dev-build marker via semver build-metadata (+sha.<short>) ([3c0e110](https://github.com/portel-dev/photon/commit/3c0e1100052a8df58bcb164a6d3f4b7780f94480))
* **webhook:** CIDR source allowlist for daemon webhook server ([26f568e](https://github.com/portel-dev/photon/commit/26f568e1db14b6cb7c4c2c09d70c146ba820e71b))

### Bug Fixes

* **a2ui:** tighter stream detection + card shape guard + RFC 6901 decode ([cd23d13](https://github.com/portel-dev/photon/commit/cd23d1319d3c9c8065c8c03b4c729d7519df19d1))
* **add:** drop spurious fuzzy matches that echo the query back ([d525640](https://github.com/portel-dev/photon/commit/d52564034e6023e77df0aca1756601c8908cb6df))
* **cli-runner:** cast hint to string for 'a2ui' comparison ([8e3d26d](https://github.com/portel-dev/photon/commit/8e3d26d61064d444d27592a49426355cbbd97a2a))
* **cli,daemon:** bundled-photon guard runs first + legacy-key sweep on disable ([ddb1423](https://github.com/portel-dev/photon/commit/ddb1423a12786e07e10e4a714b6e20d98b34da86))
* **cli,server:** photon ps --base flag + revert hot-reload heuristic ([7f0b94a](https://github.com/portel-dev/photon/commit/7f0b94a03baa20a741763cb10a4e1d47ccd324fe))
* **cli:** always persist PHOTON_DIR in mcp install when workspace != ~/.photon ([0fd0ec3](https://github.com/portel-dev/photon/commit/0fd0ec38d22bf6ddcabd40a258ecfe346ac34ded))
* **cli:** exclude lifecycle hooks from photon cli method listing ([6a8adb7](https://github.com/portel-dev/photon/commit/6a8adb7d63145400a6e9020fa0e517ae9bce319c))
* **cli:** preserve JSDoc paragraph breaks in photon cli help output ([a70f759](https://github.com/portel-dev/photon/commit/a70f75980e9a6abb310c06d2fd49884703f038ba))
* **cli:** show subcommands in group --help (maker, host, marketplace) ([e28f81e](https://github.com/portel-dev/photon/commit/e28f81e4016e79564cac6f36bb08bca7d36abf80))
* **context-store:** honor PHOTON_DIR for instance state, env, state log paths ([7df9fcd](https://github.com/portel-dev/photon/commit/7df9fcdda4ac02b782a7f2ee93d05e7faab83a9e))
* **context:** require .marketplace/ for PHOTON_DIR detection (with one-release transition) ([0eac2a0](https://github.com/portel-dev/photon/commit/0eac2a08f114efa51fbdcd9b9a83ca17f9f70ce3))
* **daemon,ag-ui:** hot-rescan and AG-UI adapter both normalize with boot discovery ([7578ed0](https://github.com/portel-dev/photon/commit/7578ed0e1912398446fa5b8133fb6d130ee1d62e))
* **daemon,bridge:** webhook tracker scoped to base + Beam card heuristic mirrors server ([e1b08ad](https://github.com/portel-dev/photon/commit/e1b08add996fec084af64924389d7a3e58d19476))
* **daemon,cli,a2ui:** scope cross-base drops, walk to workspace root, preserve A2UI escape-hatch fields ([fdf3ad9](https://github.com/portel-dev/photon/commit/fdf3ad9a9bf6732fedc0e79c626d8e50c3c8f042))
* **daemon,cli:** proactive locations keyed by base + a2ui handles null ([e8e07d0](https://github.com/portel-dev/photon/commit/e8e07d0b3b280eb1e43847b3f55576ca6d09a0a3))
* **daemon,cli:** restore default-base schedules + tighten A2UI heuristic ([58766a2](https://github.com/portel-dev/photon/commit/58766a2435de767da12313c5de3cc4eac9085e30))
* **daemon,cli:** three regressions from round-6 fixes ([a6f9d98](https://github.com/portel-dev/photon/commit/a6f9d981e2810c7b6e36087d861d26db8333a0fa))
* **daemon,serv:** SQLite history partitioned by base + loginUrl honors config override ([175b4ab](https://github.com/portel-dev/photon/commit/175b4ab0d719135aa7cd70c261e9ea5f5d979db2))
* **daemon:** auto-register uses loader.baseDir so enabled schedules don't double ([7bd3163](https://github.com/portel-dev/photon/commit/7bd316378eadc2b6e56e1dcce3c2b5c954c1f0b8))
* **daemon:** disk fallback for peer resolution in getOrCreateSessionManager ([57a2f17](https://github.com/portel-dev/photon/commit/57a2f17982e37a82205ebeb0ca610ee052a65bea))
* **daemon:** hot-reload preserves fresh _settings schema + backing ([bc8a8df](https://github.com/portel-dev/photon/commit/bc8a8dfa9842256ae6f50768981573b73a33d573))
* **daemon:** resolve peer photons with marketplace → global fallback ([22bb417](https://github.com/portel-dev/photon/commit/22bb417e4c6fb61f68cbf2900e4c0cd7804bac10))
* **daemon:** scope schedule keys by PHOTON_DIR to prevent cross-base collision ([950a798](https://github.com/portel-dev/photon/commit/950a798490b72e5ff56b9c04a0a861e468dc8f5a))
* **daemon:** sessionManagers + autoRegistered keyed by (photon, base) ([da19f05](https://github.com/portel-dev/photon/commit/da19f057845e7b659e3ed77e04791766ec30a349))
* **daemon:** split SQLite history schema into 3 phases + partition sweep by base ([347d683](https://github.com/portel-dev/photon/commit/347d6839e78115638cedfb0d9e9bf6b0c159ad20))
* **daemon:** webhookRoutes keyed by base + disable sweep scoped to base ([88db561](https://github.com/portel-dev/photon/commit/88db561acf3b6c9e5029bddef778e58ef8f1dc18))
* **doctor:** don't warn on expected overlap between built-in marketplaces ([29e81c0](https://github.com/portel-dev/photon/commit/29e81c0796fef25044d85d1fa02c32e933a6c146))
* **hot-reload:** pass { reason: 'hot-reload', oldInstance } to Beam hooks ([5a42eea](https://github.com/portel-dev/photon/commit/5a42eeaddb61ff45cf49e49f71cb2019ce506193))
* **info:** wrap single-photon --mcp output in mcpServers ([39d54ae](https://github.com/portel-dev/photon/commit/39d54ae8ec87fb1e142a633de71874fd3b68b696))
* **loader:** always inject this.call on plain classes ([90500ab](https://github.com/portel-dev/photon/commit/90500ab98f015dd606a6ca8be14e09fa6933ea39))
* **loader:** always-inject cheap capabilities regardless of cap detection ([58dc00d](https://github.com/portel-dev/photon/commit/58dc00d04b21d3170e222a3442d932bc750cfbb2))
* **loader:** pin instance._baseDir at both load sites + cross-process regression test ([8835a34](https://github.com/portel-dev/photon/commit/8835a3414d7b6e72ac919274dfbe1ea0e038a08b))
* **marketplace,info:** stop leaking marketplace-manager noise into user commands ([39f3070](https://github.com/portel-dev/photon/commit/39f30703f17f60641478fb1730f9cbee6838abb4))
* **migration:** drop detectNamespace; flat photons migrate under empty namespace ([675fcd0](https://github.com/portel-dev/photon/commit/675fcd0a21edefe21ad9d82490d63a8f683366fb))
* **namespace:** data layout mirrors source layout, no more git-remote guessing ([fd7cf69](https://github.com/portel-dev/photon/commit/fd7cf6923da02b0a95d5821e4f8643d3ff249885))
* **ps,a2ui:** ps forwards opts.base as-is + A2UI escapes key JSON pointers ([1b88ab4](https://github.com/portel-dev/photon/commit/1b88ab4f0a246c29d786cfec930825b015f450e7))
* **ps,bridge:** default schedule ops to current base + Beam A2UI classifier ([318feb3](https://github.com/portel-dev/photon/commit/318feb33cbd0413d95013b02c2f72fe3835a278b))
* **schedules:** route writes through PHOTON_DIR, read new + legacy ([ee1b1a9](https://github.com/portel-dev/photon/commit/ee1b1a9503d5cacb48fffee591e1d7e0563260dc))
* **serv,server,cli:** three regressions surfaced by codex re-review ([315a4d9](https://github.com/portel-dev/photon/commit/315a4d9bd421889442769eef090540db59331460))
* **server:** don't stomp fresh initializer values during hot-reload state copy ([ff32ea7](https://github.com/portel-dev/photon/commit/ff32ea73818b6073929bf01c61c49e12a46756d4))
* **server:** pass { reason: 'shutdown' } to onShutdown on Beam stop ([817ed1c](https://github.com/portel-dev/photon/commit/817ed1c20ac623e5a3318473ae6b60955a3cb547))
* **serv:** ES256 emits RFC 7518 P1363 + OIDC nonce echoed into id_token ([7fabacd](https://github.com/portel-dev/photon/commit/7fabacd40de608a087832fe360fd9cfeb2db97b1))
* **serv:** peek auth code + pending consent before validation ([47915fe](https://github.com/portel-dev/photon/commit/47915fea1bde11e94ec7d99b15d97a9669ddd5d3))
* **serv:** PKCE challenge uses SHA-256 per RFC 7636, harden CIMD resolution ([89990eb](https://github.com/portel-dev/photon/commit/89990ebf36d45b77ba4995f9c232967ca13b8342))
* **serv:** tenant-scoped default loginUrl in buildEndpointDeps ([b909ffd](https://github.com/portel-dev/photon/commit/b909ffd512444a0b4e632e41c59a61159bbcee05))
* **storage:** resolve compiled-photon storage paths under PHOTON_DIR, not hardcoded ~/.photon ([6403193](https://github.com/portel-dev/photon/commit/640319341c6df40c99d90819af23dadef1214d60))
* **tasks:** resolve tasks dir per call instead of at module import ([fa52820](https://github.com/portel-dev/photon/commit/fa528203324a7ba8db897e172ffd15d042de3a15))
* **templates:** align scaffold banner and response style with docs ([4a12ee6](https://github.com/portel-dev/photon/commit/4a12ee64365905585d7d180274a96a4dd9e20534))
* **tests:** cimd 304 mock + format-coverage scan walks matching brace ([6d6d3c3](https://github.com/portel-dev/photon/commit/6d6d3c3bad95788fffd796b61d84b2549e4413cb))
...
* [@channel](https://github.com/channel) tag — photons as Claude Code channels via capabilities negotiation ([7d02579](https://github.com/portel-dev/photon/commit/7d025798379b97382b1f5cd0721088cc63348b69))
* auto-migration to .data/ layout and version upgrade notifications ([fd00c1e](https://github.com/portel-dev/photon/commit/fd00c1e1779a44fb717e50ab4fad53b4b73079c0))
* channel permission relay and callable channel object ([207ad98](https://github.com/portel-dev/photon/commit/207ad98df7429c49d95d396740717d1a1cd84828))
* client-agnostic channel support via clientInfo name detection ([c791c49](https://github.com/portel-dev/photon/commit/c791c495a907934d1f728f32c7961eb5d5aef8a8))
* elicitation custom message + render('guide') stepper widget ([46aee31](https://github.com/portel-dev/photon/commit/46aee314f6b7492402d013cb7a873e903b11b9f1))
* enhanced slides — moods, themes, backgrounds, responsive sizing ([cff3c47](https://github.com/portel-dev/photon/commit/cff3c4797826f44f3c5ef94f8e88bbb8a3935d76))
* ghost syntax — adaptive near-invisible markdown markers in CLI ([4db5327](https://github.com/portel-dev/photon/commit/4db5327da0e9ebd693c06f9b3f52e11d806b24c8))
* loader resolves and propagates namespace to all photon instances ([9c33073](https://github.com/portel-dev/photon/commit/9c33073cd598a2c938c392e3d07ec2510ba46c46))
* maker init adds .data/ to .gitignore automatically ([42ab05e](https://github.com/portel-dev/photon/commit/42ab05ee9a52d6125059f4e165e3761fab5d9bc8))
* migrate photon runtime to .data/ consolidated data layout ([5e250e1](https://github.com/portel-dev/photon/commit/5e250e1424cee273f295dd71f5cda222255530e8))
* non-blocking version check with changelog highlights ([3a00a98](https://github.com/portel-dev/photon/commit/3a00a988f292b9da815eee5b1cc700b916389114))
* photon add supports qualified names (marketplace/name, owner/repo/name) ([79279d4](https://github.com/portel-dev/photon/commit/79279d49fe375cc274988dad5d9688e4311c449a))
* photon update actually upgrades, photon changelog shows what's new ([52d0445](https://github.com/portel-dev/photon/commit/52d04454da608e69a0b6bb8b9bc2d7b52ad063a4))
* rename push() to channel(), support [@channel](https://github.com/channel) targets ([57326eb](https://github.com/portel-dev/photon/commit/57326eb8f8ed0f609002d865aac1eebe4f996e6c))
* slides phase 6-8 — theme dedup, fonts, text effects ([aacfde0](https://github.com/portel-dev/photon/commit/aacfde09352c55155884de079e502c56ecceb57a))

### Bug Fixes

* [@dependencies](https://github.com/dependencies) parser only matches inside JSDoc blocks ([d79a7a6](https://github.com/portel-dev/photon/commit/d79a7a6f606e923f8e6320b292d9b3b7a8c3120e))
* [@dependencies](https://github.com/dependencies) without version spec silently skipped ([76ce342](https://github.com/portel-dev/photon/commit/76ce342c697cd3a29a46dad5b1ece1bf47fde1b8))
* auto-detect photon directory from cwd when PHOTON_DIR is not set ([1baf8c7](https://github.com/portel-dev/photon/commit/1baf8c7b4fa21f9ce1ff912e4ea360c25bfbe39a))
* auto-install [@photon](https://github.com/photon) transitive dependencies on marketplace install ([4c93593](https://github.com/portel-dev/photon/commit/4c9359358a69ecdae222d510282d09367ddc0dec))
* Beam file watcher ignores runtime data subdirectories ([fd1e846](https://github.com/portel-dev/photon/commit/fd1e8460a07737f8a6bc5677207790aff65461a6))
* bind instance context when capturing emit for channel injection ([6fc5155](https://github.com/portel-dev/photon/commit/6fc5155a4fbffe9950c9a55fc20f098a8edf0abe))
* bridge InProcessBroker to daemon socket subscribers ([6188a8b](https://github.com/portel-dev/photon/commit/6188a8bc5fab96709d017949710f4fc916ccf942))
* bridge slides get background effects, scan lines, theme signatures ([2dbc374](https://github.com/portel-dev/photon/commit/2dbc37417e5a92ba9a8a396e0d55d7a7fa0c7d93))
* CLI auto-restarts stale daemon before running stateful photons ([1abb16f](https://github.com/portel-dev/photon/commit/1abb16ffc85cae35c36a6e5066be8d2f0b564ff3))
* confirm dialog dark theme fallbacks, sidebar refresh after delete ([8d43274](https://github.com/portel-dev/photon/commit/8d432746ad3abd7869b607792e60887585403ffc))
* confirm dialog renders inside beam-app shadow root for theme tokens ([9c86f77](https://github.com/portel-dev/photon/commit/9c86f77fb5016b4fbe452e6aa4f8f243ef65fa6d))
* cwd with .photon.ts files takes priority over stale PHOTON_DIR ([4a05707](https://github.com/portel-dev/photon/commit/4a0570716f6164f33d2ad5bdf0848c2561e166a5))
* don't inject into README when markers are removed ([1339243](https://github.com/portel-dev/photon/commit/13392436263893371f42d58d12d1eecdf493364d))
* extract class-level JSDoc for channel instructions, not first comment in file ([7a4b63b](https://github.com/portel-dev/photon/commit/7a4b63b32a13b8d5e985be9e57867a71284b730d))
* file watcher skips .data/ entirely and only reloads on ui/ changes ([ced7660](https://github.com/portel-dev/photon/commit/ced76603f3e90aeed272613ca2732699e3691868))
* force chalk truecolor on TTY, enabling proper ghost RGB colors ([ae3a3ed](https://github.com/portel-dev/photon/commit/ae3a3edfec364e377b666c10fb321c5067b1d1f5))
* ghost bypasses chalk with raw ANSI escapes ([8136187](https://github.com/portel-dev/photon/commit/8136187488d3dcf86504e8196f7a12b195ac4094))
* ghost color uses ANSI 256 instead of truecolor RGB ([71af1d1](https://github.com/portel-dev/photon/commit/71af1d1bb8aa10d7e2150978ee5e1f32f8df23a3))
* ghost color uses chalk.dim.gray for universal terminal support ([58162a4](https://github.com/portel-dev/photon/commit/58162a4f075c526180e9d9dbab6a90e5cfa85875))
* ghost forces chalk.level inside function call ([fe672b8](https://github.com/portel-dev/photon/commit/fe672b8e6879688110dbf39cf8c184480f5ccf19))
* ghost strips markdown syntax instead of ANSI tricks ([9c2dedc](https://github.com/portel-dev/photon/commit/9c2dedcd0a6bd916550ff94ba8bce1619e352c2e))
* ghost syntax handles bold+link combo and ordering ([4893102](https://github.com/portel-dev/photon/commit/489310204cc5fbfb0106fe037d84cc50689cbf69))
* ghost TTY detection checks TERM env as fallback for bun ([b1c547d](https://github.com/portel-dev/photon/commit/b1c547da70955fec64c719649f0cdc98f5b70fb7))
* ghost uses ANSI hidden attribute for truly invisible syntax ([5bb817d](https://github.com/portel-dev/photon/commit/5bb817d0f84e609a110df2fe7989dfbef74859bb))
* ghost uses chalk.gray (basic ANSI) — no truecolor dependency ([4f13a0c](https://github.com/portel-dev/photon/commit/4f13a0c094a0e3ede5cce31e9009f687cca6687c))
* ghost uses String.fromCharCode(27) for ESC to avoid stripping ([2a3fd17](https://github.com/portel-dev/photon/commit/2a3fd17037afd7b079dff103112d4f94d2cda720))
* handle global install failures gracefully in pre-release check ([0924b54](https://github.com/portel-dev/photon/commit/0924b546a85e6ab6da5bba9279f610fa4056496e))
* light slide themes (editorial, swiss) apply bg to viewport too ([76e28ca](https://github.com/portel-dev/photon/commit/76e28ca8b738961972de81721eadc611beeff225))
* loader dependency cache uses .data/.cache/dependencies/ ([808a6d3](https://github.com/portel-dev/photon/commit/808a6d3197442a99778a72010da55c818a397207))
* markdown array CLI output now uses ghost syntax rendering ([428a7c3](https://github.com/portel-dev/photon/commit/428a7c367a9f6261e9c3f05f303ba99e6aea936a))
* MCP Streamable HTTP compatibility for llama.cpp and modern clients ([dffde7d](https://github.com/portel-dev/photon/commit/dffde7dbe0f9b982878ee1080774e7c950aee4ee))
* mood entrance animations + more visible gradient-mesh drift ([526b695](https://github.com/portel-dev/photon/commit/526b69514cbf507b16d9daa142fed9c892676f66))
* namespace channel-push events with photon name for daemon routing ([ced8c51](https://github.com/portel-dev/photon/commit/ced8c5134507fe4aa130176130e47e839ec5428e))
* pass baseDir to MemoryProvider so memory reads from correct directory ([79b6419](https://github.com/portel-dev/photon/commit/79b64199378bfab954ff4c89f9143a7fbb033cf0))
* PHOTON_DIR respected across all CLI commands and entry points ([10d5b2d](https://github.com/portel-dev/photon/commit/10d5b2d622bc49fd0e194993c9e72c2f6aca03a3))
* retry dep install on 'require is not defined' error ([4f86434](https://github.com/portel-dev/photon/commit/4f86434c64dc56460004bb61caafdaf95b40b989))
* route channel push through daemon pub/sub, not direct handler injection ([51f1723](https://github.com/portel-dev/photon/commit/51f172379840d5de28b0c2042ead900c319208b7))
* route channel push through daemon pub/sub, skip daemon subscription in channel mode ([cfbe005](https://github.com/portel-dev/photon/commit/cfbe005d116786c27eb1979b37a646bffd619a8f))
* run channel photons in-process, skip daemon to avoid poll conflicts ([95c308c](https://github.com/portel-dev/photon/commit/95c308c1d4bd0e38c394a81b0640b1fecd44aee4))
* simplify ghost to chalk.gray — relies on chalk.level = 1 at import ([c14ee0b](https://github.com/portel-dev/photon/commit/c14ee0b2d3c3d832a56c8bff72909d278af65bc3))
* simplify watcher — .data/ filter is sufficient now that storage() is fixed ([acd74ac](https://github.com/portel-dev/photon/commit/acd74acc41ce6a82534c6b9d1340a7a95a5855f2))
* slide children hidden until stagger applies data-enter ([8597d57](https://github.com/portel-dev/photon/commit/8597d575b6ced2aa26ea8a8520df347928d15ba0))
* slim update notice, on-demand changelog via photon update --changelog ([8154873](https://github.com/portel-dev/photon/commit/815487355d98f8a76ca104e08c62af7eca5663fc))
* stagger fallback reveals slide content after 1.5s timeout ([fc857ab](https://github.com/portel-dev/photon/commit/fc857abc8aa63916d3e55b8253b39e039cd4917c))
* text effects (typing, scramble, wave, fly-in) work in bridge iframe ([a9ffef1](https://github.com/portel-dev/photon/commit/a9ffef10c58b647c2b2f84538fa3de555ecfeb5a))
* tolerate semver range prefix in photon-core version comparison ([4f55784](https://github.com/portel-dev/photon/commit/4f55784478c29abc12ad7276a9da7987fec36743))
* unset PHOTON_DIR after fresh install simulation in pre-release check ([d618c06](https://github.com/portel-dev/photon/commit/d618c0627a93d660adebc58ddf81cfa2041bd278))
* untrack test fixture data files, gitignore tests/**/.data/ ([1f2ec8e](https://github.com/portel-dev/photon/commit/1f2ec8eb422dfe6d3dd5ae2c2c77384a1344ad46))
* update tests for Streamable HTTP transport ([6d8f37a](https://github.com/portel-dev/photon/commit/6d8f37a62553dcd54ca0dfd25dd255943851e89d))
* use absolute tarball path in global install test, stop cd-ing ([847792e](https://github.com/portel-dev/photon/commit/847792e33c14015b831564e64bad1df6ae8bbbfd))
* use photon basename for channel server name, not raw CLI argument ([5d1b66b](https://github.com/portel-dev/photon/commit/5d1b66beaaffbc98c6e6ac559fc084718a5dff68))
* wait for auto-connect before activating channel polling, skip daemon subscription in channel mode ([9fa9d3c](https://github.com/portel-dev/photon/commit/9fa9d3c2eb9b97703157f56e04d8ee5760f3376e))
