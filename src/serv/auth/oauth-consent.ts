...
.oauth-shell{width:min(100%,500px)}
.oauth-card{background:var(--oauth-panel);border:1px solid var(--oauth-line);border-radius:16px;box-shadow:0 12px 35px var(--oauth-shadow);overflow:hidden}
